# Generated by Django 4.2.16 on 2024-12-04 20:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('vivriere', 'Culture Vivrière'), ('industrial', 'Culture Industrielle'), ('rente', 'Culture de Rente'), ('maraichere', 'Culture Maraîchère'), ('fruitiere', 'Culture Fruitière'), ('specialisee', 'Culture Spécialisée'), ('florale', 'Culture Florale et Ornementale'), ('emergente', 'Culture Émergente')], max_length=50, verbose_name='Catégorie')),
                ('nom_culture', models.CharField(choices=[('vivriere', 'Culture Vivrière'), ('industrial', 'Culture Industrielle'), ('rente', 'Culture de Rente'), ('maraichere', 'Culture Maraîchère'), ('fruitiere', 'Culture Fruitière'), ('specialisee', 'Culture Spécialisée'), ('florale', 'Culture Florale et Ornementale'), ('emergente', 'Culture Émergente')], max_length=200, unique=True, verbose_name='Nom de la Culture')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ...
                ('autre_culture', models.CharField(choices=[('perennial', 'Culture Pérenne'), ('seasonal', 'Culture Saisonnière')], max_length=50, verbose_name='Type')),
                ('autre_culture_nom', models.CharField(choices=[('vivriere', 'Culture Vivrière'), ('industrial', 'Culture Industrielle'), ('rente', 'Culture de Rente'), ('maraichere', 'Culture Maraîchère'), ('fruitiere', 'Culture Fruitière'), ('specialisee', 'Culture Spécialisée'), ('florale', 'Culture Florale et Ornementale'), ('emergente', 'Culture Émergente')], max_length=200)),
                ('autre_culture_volume_ha', models.IntegerField()),
                ('nom_cooperative', models.CharField(max_length=100)),
                ('is_president', models.BooleanField(default=False, verbose_name='President ?')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Date de Création')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Date de Mise à Jour')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tracelan.employee')),
                ('localite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='localite_producteur', to='tracelan.ville')),
