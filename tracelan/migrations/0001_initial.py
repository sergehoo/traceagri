# Generated by Django 4.2.16 on 2024-12-02 20:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('culture_perenne', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='cultureperenne', to='tracelan.cultureperennial')),
                ('culture_saisonniere', models.ManyToManyField(blank=True, related_name='culturesaison', to='tracelan.cultureseasonal')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('culture_perenne', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='tracelan.cultureperennial')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='cultureseasonal',
            name='parcelle',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cultures_seasonal', to='tracelan.parcelle'),
        ),
        migrations.AddField(
            model_name='cultureperennial',
            name='parcelle',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cultures_perennial', to='tracelan.parcelle'),
        ),
        migrations.CreateModel(
